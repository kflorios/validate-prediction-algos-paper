...
source("functions_Monte_Cclass_tune.R")
...
fnameX <- paste("Xall",".txt",sep="")
fnameY <- paste("Yall",".txt",sep="")
...
save.image(file="Monte_SHYKJG1_5methods_R200_tuneSVM_Cclass_Blos_and_Br.RData")
